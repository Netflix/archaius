...
class DynamicDoublePropertyTest extends WordSpec with ShouldMatchers {
  private val propertyName = "dynamicDoubleTest"
  private val property = dynamicDoubleProperty(propertyName, 1.0D)
