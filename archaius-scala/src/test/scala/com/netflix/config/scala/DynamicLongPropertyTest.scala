...
class DynamicLongPropertyTest extends WordSpec with ShouldMatchers {
  private val propertyName = "dynamicLongTest"
  private val property = dynamicLongProperty(propertyName, 1L)
